<?php
	...
	$query = mysqli_query($connection, "SELECT * FROM hostel_due WHERE roll_number='".$_SESSION['roll']."'");
  ...
  <body>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  <li role="presentation"><a href="student-profile.php">Mess Due</a></li>
		  <li role="presentation" class="active"><a href="#">Hostel Due</a></li>
